...
/***/ function(module, exports, __webpack_require__) {
	...
	var _knucklebone = __webpack_require__(1);
	...
	window.knucklebone = _knucklebone2.default;

	(0, _lodash2.default)(document.getElementsByTagName('input'), function (input) {
	...
	var parser = _finalform2.default.create(form);

	parser.validations({
	  path: function path(element) {
	    if (element.value.trim().length) return true;else element.classList.add('error');
	  }
	});
